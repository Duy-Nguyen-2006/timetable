...
This project is indexed by GitNexus as **timetable** (5750 symbols, 9509 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
