...
This project is indexed by GitNexus as **timetable** (6022 symbols, 10048 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
