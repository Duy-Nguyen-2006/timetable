...
This project is indexed by GitNexus as **timetable** (1612 symbols, 2706 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
