...
This project is indexed by GitNexus as **timetable** (5067 symbols, 8040 relationships, 228 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
