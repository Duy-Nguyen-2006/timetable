...
This project is indexed by GitNexus as **timetable** (1872 symbols, 3059 relationships, 69 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
