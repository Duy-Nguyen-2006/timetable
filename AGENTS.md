...
This project is indexed by GitNexus as **timetable** (5760 symbols, 9527 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
