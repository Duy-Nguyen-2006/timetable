...
This project is indexed by GitNexus as **timetable** (5307 symbols, 8580 relationships, 272 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
