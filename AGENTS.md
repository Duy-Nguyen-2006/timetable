...
This project is indexed by GitNexus as **timetable** (5912 symbols, 9697 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
