...
This project is indexed by GitNexus as **timetable** (5343 symbols, 8620 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
