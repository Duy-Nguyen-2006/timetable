...
This project is indexed by GitNexus as **timetable** (6435 symbols, 10822 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
