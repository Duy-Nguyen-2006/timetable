...
This project is indexed by GitNexus as **timetable** (5150 symbols, 8247 relationships, 250 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
