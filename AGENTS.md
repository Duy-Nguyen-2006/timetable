...
This project is indexed by GitNexus as **timetable** (1191 symbols, 2092 relationships, 46 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
