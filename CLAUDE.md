...
This project is indexed by GitNexus as **timetable** (6290 symbols, 10592 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
