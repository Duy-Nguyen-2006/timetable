...
| **PASS** (rule + AI cho ra spec hợp lệ) | 117 | 78.0% |
| **PARTIAL** (cần user feedback/custom_dsl) | 33 | 22.0% |
...
| 2-periods | Cơ bản về tiết | 18 | 2 | 0 | 90% |
| 3-day-period | Kết hợp ngày + tiết | 20 | 0 | 0 | 100% |
| 4-if-then-simple | IF/THEN đơn giản | 19 | 1 | 0 | 95% |
...
| 26 | Lan dạy tiết 2 và tiết 4 | medium | translator | medium | 4 | - | ✅ PASS | - |
...
| 29 | Quân dạy tiết 3 | medium | translator | medium | 5 | - | ✅ PASS | - |
| 30 | Nam không dạy tiết đầu tiên | medium | translator | medium | 1 | - | ✅ PASS | - |
| 31 | Phương chỉ dạy tiết 1, 2, 3 | medium | translator | medium | 3 | - | ✅ PASS | - |
...
| # | Input | Rule Conf | Source | Final Conf | #Specs | Custom DSL | Status | Ghi chú |
|---|---|---|---|---|---|---|---|---|
| 41 | Hiếu dạy thứ 2 tiết 1 | medium | translator | medium | 5 | - | ✅ PASS | - |
...
| 44 | Mai dạy thứ 6 tiết 2 hoặc tiết 3 | medium | translator | medium | 4 | - | ✅ PASS | - |
| 45 | Tuấn không dạy thứ 2 tiết 4 | medium | translator | medium | 1 | - | ✅ PASS | - |
| 46 | Lan dạy thứ 3 tiết 1, 2, 3 | medium | translator | medium | 3 | - | ✅ PASS | - |
...
| 49 | Quân dạy thứ 7 tiết 1 và tiết 2 | medium | translator | medium | 4 | - | ✅ PASS | - |
...
| 55 | Đạt dạy thứ 2 tiết 5 | medium | translator | medium | 5 | - | ✅ PASS | - |
...
| 58 | Nhung dạy thứ 3 tiết lẻ | medium | translator | medium | 3 | - | ✅ PASS | - |
...
| 71 | Nếu Phương dạy tiết 5 thì Trang dạy tiết 5 | medium | translator | medium | 5 | - | ✅ PASS | - |
...
| 77 | Nếu Thảo dạy tiết 1 thì Nhung phải dạy tiết 2 | medium | translator | medium | 4 | - | ✅ PASS | - |
...
| 122 | Long dạy ít nhất 8 tiết trong tuần | medium | translator | medium | 1 | - | ✅ PASS | - |
| 123 | Dung không dạy quá 6 tiết trong tuần | low | translator | medium | 1 | Có | ⚠️ PARTIAL | - |
| 124 | Mai dạy từ 4 đến 7 tiết trong tuần | medium | translator | medium | 2 | - | ✅ PASS | - |
...
| 130 | Nam dạy từ 6 đến 9 tiết trong tuần | medium | translator | medium | 2 | - | ✅ PASS | - |
...
### Điểm cần cải thiện
- 33 constraints cần user feedback. Ví dụ điển hình:
  ...
  - #35: "Đạt chỉ dạy 1 tiết mỗi ngày" → translator (1 specs)
  - #36: "Khánh không dạy quá 4 tiết mỗi ngày" → translator (1 specs)
  - #78: "Nếu Nhung không dạy thứ 7 thì Toàn dạy thứ 7" → translator (1 specs)
...
Với 150 constraints đa dạng, hệ thống đạt **78.0%** tỷ lệ pass (không cần user feedback). Kết hợp rule parser + LLM (deepseek/deepseek-v4-flash) cho kết quả khả quan. Các constraints còn lại (33 partial, 0 fail) thuộc nhóm phức tạp và cần user feedback hoặc custom DSL.
