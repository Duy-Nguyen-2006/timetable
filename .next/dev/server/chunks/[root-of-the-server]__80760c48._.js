...
"[project]/src/app/api/provider/test/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!baseURL || !apiKey) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                message: 'Thiếu Base URL hoặc API Key.'
            }, {
                status: 400
            });
        }
        ...
        if (model) {
            ...
            if (chatRes.ok) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    ok: true,
                    message: '✅ Kết nối thành công! /models không khả dụng nhưng model vẫn gọi được qua /chat/completions.'
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__80760c48._.js.map