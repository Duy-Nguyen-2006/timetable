...
export const CONSTRAINT_REGISTRY: ConstraintMeta[] = [
  ...
  { kind: 'teacher_min_off_days', label: 'Teacher min off days', group: 'teacher', hasChecker: false, requiredParams: ['teacher', 'minOffDays'] },
  ...
  { kind: 'teacher_group_not_same_day', label: 'Teacher group not same day', group: 'teacher', hasChecker: true, requiredParams: ['teachers'] },
  { kind: 'teacher_group_min_per_day', label: 'Teacher group min per day', group: 'teacher', hasChecker: true, requiredParams: ['teachers', 'minCount'] },
  { kind: 'teacher_group_not_same_period', label: 'Teacher group not same period', group: 'teacher', hasChecker: true, requiredParams: ['teachers'] },
  { kind: 'teacher_group_max_concurrent', label: 'Teacher group max concurrent', group: 'teacher', hasChecker: true, requiredParams: ['teachers', 'maxConcurrent'] },
  { kind: 'teacher_group_exact_per_day', label: 'Teacher group exact per day', group: 'teacher', hasChecker: true, requiredParams: ['teachers', 'exactCount'] },
  { kind: 'teacher_group_total_periods', label: 'Teacher group total periods', group: 'teacher', hasChecker: true, requiredParams: ['teachersA', 'teachersB'] },
  { kind: 'subject_consecutive_periods', label: 'Subject consecutive periods', group: 'subject', hasChecker: true, requiredParams: ['subject', 'length'] },
  { kind: 'global_min_teachers_per_period', label: 'Global min teachers per period', group: 'global', hasChecker: true, requiredParams: ['minCount'] },
  { kind: 'global_max_teachers_per_period', label: 'Global max teachers per period', group: 'global', hasChecker: true, requiredParams: ['maxCount'] },
  { kind: 'global_exact_teachers_per_period', label: 'Global exact teachers per period', group: 'global', hasChecker: true, requiredParams: ['exactCount'] },
  { kind: 'teacher_priority_day', label: 'Teacher priority day', group: 'teacher', hasChecker: true, requiredParams: ['teacher'] },
  { kind: 'teacher_priority_session', label: 'Teacher priority session', group: 'teacher', hasChecker: true, requiredParams: ['teacher', 'session'] },
  { kind: 'teacher_unavailable_holiday', label: 'Teacher unavailable holiday', group: 'teacher', hasChecker: true, requiredParams: ['teacher'] },
  { kind: 'teacher_unavailable_sudden', label: 'Teacher unavailable sudden', group: 'teacher', hasChecker: true, requiredParams: ['teacher'] },
  { kind: 'teacher_break_time_minutes', label: 'Teacher break time minutes', group: 'teacher', hasChecker: true, requiredParams: ['teacher', 'minutes'] },
  { kind: 'global_max_workload_diff', label: 'Global max workload diff', group: 'global', hasChecker: true, requiredParams: ['maxDiff'] },
  { kind: 'subject_after_subject_week', label: 'Subject after subject week', group: 'subject', hasChecker: true, requiredParams: ['subjectA', 'subjectB'] },
  { kind: 'subject_before_subject_week', label: 'Subject before subject week', group: 'subject', hasChecker: true, requiredParams: ['subjectA', 'subjectB'] },
  { kind: 'subject_same_week', label: 'Subject same week', group: 'subject', hasChecker: true, requiredParams: ['subjectA', 'subjectB'] },
  { kind: 'subject_gap_weeks', label: 'Subject gap weeks', group: 'subject', hasChecker: true, requiredParams: ['subjectA', 'subjectB', 'gapWeeks'] },
  { kind: 'subject_min_gap_hours', label: 'Subject min gap hours', group: 'subject', hasChecker: true, requiredParams: ['subjectA', 'subjectB', 'minHours'] },
  { kind: 'subject_after_break', label: 'Subject after break', group: 'subject', hasChecker: true, requiredParams: ['subject', 'afterPeriod'] },
  { kind: 'teacher_min_rest_between_days', label: 'Teacher min rest between days', group: 'teacher', hasChecker: true, requiredParams: ['teacher', 'minRestDays'] },
  { kind: 'teacher_max_hours_per_day', label: 'Teacher max hours per day', group: 'teacher', hasChecker: true, requiredParams: ['teacher', 'maxHours'] },
  { kind: 'teacher_lunch_break_required', label: 'Teacher lunch break required', group: 'teacher', hasChecker: true, requiredParams: ['teacher'] },
  { kind: 'teacher_mentorship', label: 'Teacher mentorship', group: 'teacher', hasChecker: true, requiredParams: ['mentor', 'mentee'] },
  { kind: 'teacher_conflict', label: 'Teacher conflict', group: 'teacher', hasChecker: true, requiredParams: ['teacherA', 'teacherB'] },
