...
export const CONSTRAINT_REGISTRY: ConstraintMeta[] = [
  ...
  { kind: 'teacher_max_per_day', label: 'Teacher max per day', group: 'teacher', hasChecker: true, requiredParams: ['teacher', 'max'] },
  { kind: 'teacher_max_consecutive', label: 'Teacher max consecutive', group: 'teacher', hasChecker: true, requiredParams: ['teacher', 'max'] },
  { kind: 'teacher_max_working_days', label: 'Teacher max working days', group: 'teacher', hasChecker: true, requiredParams: ['teacher', 'max'] },
  { kind: 'teacher_min_per_day', label: 'Teacher min per day', group: 'teacher', hasChecker: true, requiredParams: ['teacher', 'min'] },
